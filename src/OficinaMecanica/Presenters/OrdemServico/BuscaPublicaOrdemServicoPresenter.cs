...
{
    public class BuscaPublicaOrdemServicoPresenter : BasePresenter, IBuscaPublicaOrdemServicoPresenter
    {
        ...
        public void ApresentarNaoEncontrado()
        {
            // Para segurança, sempre retorna null/não encontrado
            var resultado = new JsonResult(null) { StatusCode = 200 };
