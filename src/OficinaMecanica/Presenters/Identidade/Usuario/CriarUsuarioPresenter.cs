...
{
    public class CriarUsuarioPresenter : BasePresenter, ICriarUsuarioPresenter
    {
        public void ApresentarSucesso(Domain.Identidade.Aggregates.Usuario usuario)
        {
            ...
            DefinirSucessoComLocalizacao("ObterPorDocumento", "Usuario", new { documento = usuario.DocumentoIdentificadorUsuario.Valor }, dto);
        }
    }
}