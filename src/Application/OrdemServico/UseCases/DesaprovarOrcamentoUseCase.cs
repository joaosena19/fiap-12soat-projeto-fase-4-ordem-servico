...
{
    public async Task ExecutarAsync(Ator ator, Guid ordemServicoId, IOrdemServicoGateway gateway, IVeiculoExternalService veiculoExternalService, IOperacaoOrdemServicoPresenter presenter, IAppLogger logger)
    {
        try
        {
