...
{
    public async Task ExecutarAsync(Ator ator, string codigo, IOrdemServicoGateway gateway, IVeiculoExternalService veiculoExternalService, IBuscarOrdemServicoPorCodigoPresenter presenter, IAppLogger logger)
    {
        try
        {
